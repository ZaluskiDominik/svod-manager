 ...
 */
final class Version20191130153630 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE subscription ADD description LONGTEXT NOT NULL COLLATE utf8mb4_unicode_ci');
    }
}
